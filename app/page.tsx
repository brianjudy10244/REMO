...
export default async function HomePage() {
  ...
  return <div className="shell">
    ...
    <main>
      <section className="hero"><div><div className="kicker"><span className="line"/> TEAM REMO</div><h1>{settings.headline}<br/>하나의 <span>{settings.teamName}.</span></h1><p style={{ whiteSpace: "pre-line" }}>{settings.description}</p><a className="admin" href="#projects">우리의 프로젝트 ↗</a></div><div className="hero-art"><Image src={settings.heroAssetUrl || "/assets/remo-knot.png"} alt="" width={1402} height={1122} priority /></div></section>
      <section className="section team-photo-section" id="team-photo"><div className="heading"><div><div className="kicker">TEAM REMO</div><h2>우리가 리모입니다<span className="star">.</span></h2></div><p>함께 모인 순간.</p></div><div className="team-photo"><Image src="/assets/team-photo.png" alt="REMO 팀 단체 사진" width={1170} height={870} /></div></section>
